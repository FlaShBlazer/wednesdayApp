...
public class SongListView extends AppCompatActivity implements SongListContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listTracks.setLayoutManager(new GridLayoutManager(this, 2));
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SongListView.this, HistoryActivity.class));
            }
        });
    }
    ...
    public void getTasks() {
        ...
        class GetTasks extends AsyncTask<Void, Void, List<Track>> {
            ...
            protected void onPostExecute(List<Track> tracks) {
                ...
                SongAdapter adapter = new SongAdapter(tracks, SongListView.this);
                listTracks.setAdapter(adapter);
            }
        }
